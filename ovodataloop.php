...
$err = curl_error($curl);
curl_close($curl);
for($i = 0; $i <= 364; $i++) {  //change the 364 for however many days history you want to fill
	$ch = curl_init();
	...
	//curl_setopt($ch, CURLOPT_URL ,"https://smartpaym.ovoenergy.com/api/energy-usage/half-hourly/6422168?date=".$date); 
